...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        # Obstacle 2
        self.obstacle2 = self.canvas_widget.create_image(pixels * 5, pixels * 4, anchor='nw', image=self.obstacle6_object)
        # Obstacle 3
        ...
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 5, pixels * 2, anchor='nw', image=self.obstacle4_object)
        # Obstacle 18
        ...
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 3, pixels * 6, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 7, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 4, pixels * 8, anchor='nw', image=self.obstacle2_object)

        # Final Point
        img_flag = Image.open("images/flag.png")
        self.flag_object = ImageTk.PhotoImage(img_flag)
        self.flag = self.canvas_widget.create_image(pixels * 4, pixels * 7, anchor='nw', image=self.flag_object)
        ...
        self.agent = self.canvas_widget.create_image(pixels * 5, pixels * 1, anchor='nw', image=self.robot)
